...
feature specs позволяют тестировать реальное взаимодействие пользователя с веб-приложением. Они также сразу покрывают проверку всей системы в целом, а не отдельных её компнентов.
